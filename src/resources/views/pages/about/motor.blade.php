...
@section('content')
    ...
    <div id="page_klub_mobil">
        ...
        <main>
            <div class="list_klub_motor d-flex flex-wrap row-cols-1 row-cols-md-2 row-cols-lg-3">
                        ...
                        <div style="background: linear-gradient(163.89deg, #A8891B -2.61%, #FFCE51 88.8%);
                            ...
                            <div class="content_overlay_collaps opacity_object">
                                ...
                                <div class="sosial_media_klub_mobil align-self-end">
                                    ...
                                    <img src="{{ asset('images') }}/close_icon.svg" alt="close_icon" alt="close_icon">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <button class="btn_load_more_klub_motor mx-auto d-block">
                Load More
            </button>
        </main>
    </div>
