                                ...
                                <div class="row">
                                    <div class="col-12 col-md-8 order-2 order-md-1 my-auto">
                                        ...
                                        <p class="subtitle-berita">
                                            ...
                                            <img src="{{ asset('public/images') }}/icon-arrow-right.png" alt="icon arrow"
                            ...
                            <div categories="{{ $event->categories_slug }}" style="cursor: pointer;"
                                ...
                                <div class="card-header content-event" id="headingOne">
                                    <div class="d-flex flex-wrap align-items-center justify-content-center">
                                        ...
                                        <div class="col-1">
                                            <img src="{{ asset('public/images') }}/icon-arrow-down.svg" alt="icon arrow">
                                        </div>
                                ...
                                <div id="collapse{{ $loop->iteration }}" class="collapse "
                                    ...
                                    <div class="card-body">
                                        <div class="detail-event">
                                            ...
                                            <a class="link_detail_event" href="/event/{{ $event->slug }}">Selengkapnya
                                                <span>→</span></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row mx-lg-5 no-gutters wrap_tentangImi">
                ...
                <div class="col-12 col-lg-6 ml-auto my-auto signature_imijabar position-relative">
                    ...
                    <div class="position-relative slide_tentangImi2">
                        ...
                        <img class="position-absolute" src="{{ asset('public/images') }}/line_blue.svg" alt="line_blue">
