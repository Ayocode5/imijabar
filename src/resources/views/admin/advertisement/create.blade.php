...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Create Ads</h1>

    <form action="{{ route("admin.advertisement.store") }}" enctype="multipart/form-data" method="post">
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div style="gap: 24px" class="d-flex flex-wrap">
                        <input placeholder="www.some-url.com" type="text" name="redirect_url" class="col-12 col-md-7 form-control name_sports_show" value="{{ old("redirect_url") }}" autofocus>
                    </div>
                </div>
                <div class="form-group">
                    <label for="name">Order *</label>
                    <div style="gap: 24px" class="d-flex flex-wrap">
                        <input type="number" min="0" placeholder="enter number" name="order" class="col-12 col-md-7 form-control name_sports_show" value="{{ old("order") }}" autofocus>
                    </div>
                </div>
                <div class="form-group">
