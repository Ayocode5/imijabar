...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Create Agenda</h1>

    <form action="{{ route("admin.organizations.agenda.store") }}" enctype="multipart/form-data" method="post">
        @csrf
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div style="gap: 24px" class="d-flex flex-wrap">
                        <input placeholder="Agenda Name" type="text" name="name" class="col-12 col-md-7 form-control name_sports_show" value="{{ old("name") }}" autofocus>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea required name="description" class="form-control editor" id="editor" cols="30"
