...
@section('admin_content')
    ...
    <form action="{{ route("admin.organizations.committee.update", $team_member->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method("PATCH")
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <img id="team_member_preview_image" src="{{ asset('uploads/committee/'.$team_member->photo) }}" alt="" class="w_150">
                    </div>
                </div>
                <div class="form-group">
